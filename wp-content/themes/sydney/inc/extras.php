...
function sydney_footer_credits() {
	...
	$credits 	= get_theme_mod( 'footer_credits', sprintf( esc_html__( '%1$1s. Developed by %2$2s', 'Bethany Sibala' ), '{copyright} {year} {site_title}', 'Bethany Joyce Sibala' ) );

	$tags 		= array( '{theme_author}', '{site_title}', '{copyright}', '{year}' );
	$replace 	= array( '<a rel="nofollow" href="https://facebook.com/bethanysibs">' . esc_html__( 'Bethany', 'bethany' ) . '</a>', get_bloginfo( 'name' ), '&copy;', date('Y') );
